...
import { get, add, edit, clear } from '../../actions/wordTypeActions';
import { clearErrors } from '../../actions/baseActions';

class WordTypeForm extends Component {
  constructor(props) {
    super(props);
  ...
  static getDerivedStateFromProps(props, state) {
    if (props.wordType !== state.wordType) {
      return {
...
WordTypeForm.propTypes = {
  ...
  wordType: PropTypes.object.isRequired,
  allLanguages: PropTypes.array.isRequired,
  allStatuses: PropTypes.array.isRequired
};

const mapStateToProps = state => ({
  wordType: state.wordType.current,
